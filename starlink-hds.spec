...
przechowywania różnych informacji. W szczególności jest dopasowany do
przechowywania dużych wielowymiarowych tablic (z ich danymi
pomocniczymi), gdzie potrzebny jest wydajny dostęp.
...
kontenera HDS. Struktury zapisane w tych plikach są samoopisujące się
i elastyczne; HDS obsługuje modyfikowanie i rozszerzanie poprzednio
utworzonych struktur, a także usuwanie, kopiowanie, zmianę nazwy itp.

Wszystkie informacje zapisane w plikach HDS są przenośne między
maszynami, na których HDS jest zaimplementowany, dlatego nie ma
problemu konwersji formatu przy przenoszeniu między maszynami.
...
Pliki nagłówkowe biblioteki HDS.
